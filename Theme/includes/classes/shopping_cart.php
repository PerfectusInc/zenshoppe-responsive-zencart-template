 ...
 * Modified by ZenExpert - ZX AJAX Add to Cart v1.0
 */
...
//      zen_redirect(zen_href_link($goto, zen_get_all_get_params($parameters)));
  ...
  function actionAjaxRemoveProduct2($prod) {
    if (isset($prod) && zen_not_null($prod)) $this->remove($prod);
  }
  // EOF ZX AJAX Add to Cart 1/1
}