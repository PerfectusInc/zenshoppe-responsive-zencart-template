...
<!--<div class="navNextPrevList nextprev-text"><a href="<?php //echo zen_href_link(FILENAME_DEFAULT, "cPath=$cPath"); ?>"><?php //echo zen_image_button(BUTTON_IMAGE_RETURN_TO_PROD_LIST, BUTTON_RETURN_TO_PROD_LIST_ALT); ?></a></div>-->
