...
<div class="centerColumn" id="checkoutPayAddressDefault">
    ...
    <header>
        <h4 id="checkoutPayAddressDefaultHeading"><?php echo HEADING_TITLE; ?></h4>
    </header>
	...
	<div class="content">
        ...
        <div class="row checkout-payment-address">
    		...
    		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 current-address-text">
    			<div class="alert alert-info"><?php echo TEXT_SELECTED_PAYMENT_DESTINATION; ?></div>
    		</div>
		</div>
	</div>
	<?php
