...
<!--<span class="title"><?php //echo TEXT_PRODUCT_OPTIONS; ?></span>-->
...
<div class="wrapperAttribsOptions">
	<span class="attribute_label"><?php echo $options_name[$i]; ?> : </span>
	<div class="back product_attributes"><?php echo $options_menu[$i]; ?></div>
</div>
