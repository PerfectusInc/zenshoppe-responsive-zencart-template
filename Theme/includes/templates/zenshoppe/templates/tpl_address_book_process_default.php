...
<div class="centerColumn" id="addressBookProcessDefault">
	...
	<header>
		<h4><?php if (isset($_GET['edit'])) { echo HEADING_TITLE_MODIFY_ENTRY; } elseif (isset($_GET['delete'])) { echo HEADING_TITLE_DELETE_ENTRY; } else { echo HEADING_TITLE_ADD_ENTRY; } ?></h4>
	</header>
    ...
    ?>
    <div class="content">
		<div class="alert alert-danger alert-dissmisable"><?php echo DELETE_ADDRESS_DESCRIPTION; ?></div>
	...
	<div class="next-prev">
		<div class="buttonRow forward">
			<?php echo zen_draw_hidden_field('action', 'update') . zen_draw_hidden_field('edit', $_GET['edit']) . zen_image_submit(BUTTON_IMAGE_UPDATE, BUTTON_UPDATE_ALT); ?>
        </div>
