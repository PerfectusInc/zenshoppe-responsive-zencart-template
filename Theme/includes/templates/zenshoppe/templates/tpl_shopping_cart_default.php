	...
	?>
     <tr class="<?php echo $product['rowClass']; ?>">
     	<td class="cartProductDisplay" valign="middle" width="30%">
			...
			<span id="product_name"><a href="<?php echo $product['linkProductsName']; ?>"><?php echo $product['productsName']; ?></a></span>
       ...
       <td class="cartQuantity">
        ...
        ?>
        <div class="sp-plus sp-plus_<?php echo $product['id']; ?> fff"><span class="ddd"><i class="fa fa-angle-up"></i></span></div><div class="sp-minus sp-minus_<?php echo $product['id']; ?> fff"> <span class="ddd minus"><i class="fa fa-angle-down"></i></span></div>
        <script type="text/javascript">
			var car = jQuery.noConflict();
			car('.sp-plus_<?php echo $product['id']; ?>').on('click', function(){
			 var oldVal = car('.cart_input_<?php echo $product['id']; ?>').val();
				var newVal = (parseInt(car('.cart_input_<?php echo $product['id']; ?>').val(),10) +1);
			  car('.cart_input_<?php echo $product['id']; ?>').val(newVal);
			});
			
			car('.sp-minus_<?php echo $product['id']; ?>').on('click', function(){
			 var oldVal = car('.cart_input_<?php echo $product['id']; ?>').val();
				var newVal = (parseInt(car('.cart_input_<?php echo $product['id']; ?>').val(),10) -1);
				if (oldVal > 1) {
