...
<div class="centerColumn" id="indexProductList">
	<header>
		<h4 id="productListHeading"><?php echo $breadcrumb->last(); ?></h4>
	</header>
    <?php 
		if (PRODUCT_LIST_CATEGORIES_IMAGE_STATUS == 'true' && $current_categories_description != '') {
	?>
        	...
        	<div class="row">
                ...
                <div class="category-image">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div id="categoryImgListing" class="categoryImg"><?php echo zen_image(DIR_WS_IMAGES . $categories_image, '', CATEGORY_ICON_IMAGE_WIDTH, CATEGORY_ICON_IMAGE_HEIGHT); ?>
                        </div>
                    </div>
                </div>
                <?php
