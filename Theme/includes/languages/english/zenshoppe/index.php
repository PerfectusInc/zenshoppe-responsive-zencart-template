 ...
 * @modification: added in the language defines for the comparison system 2011-01-28 5:23:52MT brit (docreativedesign.com) $
 */
...
if ( ($category_depth == 'products') || (zen_check_url_get_terms()) ) {
  ...
  define('TEXT_NO_PRODUCTS', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>There are no products to list in this category.');
  define('TEXT_NO_PRODUCTS2', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>There is no product available from this manufacturer.');
