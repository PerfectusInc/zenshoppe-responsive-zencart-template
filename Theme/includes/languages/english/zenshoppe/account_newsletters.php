...
define('SUCCESS_NEWSLETTER_UPDATED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Your newsletter subscriptions have been updated.');
?>
