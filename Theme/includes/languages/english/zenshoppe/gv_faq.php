...
define('TEXT_INFORMATION', '<a name="Top"></a><ul class="gv_faq">
  <li><a href="'.zen_href_link(FILENAME_GV_FAQ,'faq_item=1','NONSSL').'"><i class="fa fa-arrow-circle-right"></i>Purchasing ' . TEXT_GV_NAMES . '</a></li>
  <li><a href="'.zen_href_link(FILENAME_GV_FAQ,'faq_item=2','NONSSL').'"><i class="fa fa-arrow-circle-right"></i>How to send ' . TEXT_GV_NAMES . '</a></li>
  <li><a href="'.zen_href_link(FILENAME_GV_FAQ,'faq_item=3','NONSSL').'"><i class="fa fa-arrow-circle-right"></i>Buying with ' . TEXT_GV_NAMES . '</a></li>
  <li><a href="'.zen_href_link(FILENAME_GV_FAQ,'faq_item=4','NONSSL').'"><i class="fa fa-arrow-circle-right"></i>Redeeming ' . TEXT_GV_NAMES . '</a></li>
  <li><a href="'.zen_href_link(FILENAME_GV_FAQ,'faq_item=5','NONSSL').'"><i class="fa fa-arrow-circle-right"></i>When problems occur</a></li>
  </ul>
');
