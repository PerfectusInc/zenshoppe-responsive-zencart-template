...
define('TEXT_COUPON_FAILED', '<span class="alert-text important">%s</span> &nbsp; does not appear to be a valid Coupon Redemption Code. Please try typing it in again.');
...
define('TEXT_COUPON_HELP_DESC', '<p>Discount Offer:</p><p>%s</p><p class="smallText">Certain other restrictions may apply. Please see below for other details.</p>');
