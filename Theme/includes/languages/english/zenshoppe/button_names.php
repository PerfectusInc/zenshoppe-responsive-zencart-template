...
//define('BUTTON_NEXT_ALT', '<img src="'.$template->get_template_dir("",DIR_WS_TEMPLATE, $current_page_base,"images").'/next-product.png" alt="Next Product"'.'/>');
define('BUTTON_NEXT_ALT', '<i class="fa fa-angle-right data-toggle="tooltip" data-original-title="Next Product""></i></i>');
define('BUTTON_PREVIOUS_ALT', '<i class="fa fa-angle-left data-toggle="tooltip" data-original-title="Previous Product""></i></i>');
define('BUTTON_REDEEM_ALT', 'Redeem');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Product List');
define('BUTTON_REVIEWS_ALT', 'Reviews Page');
