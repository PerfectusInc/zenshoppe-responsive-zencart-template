...
define('SUCCESS_NOTIFICATIONS_UPDATED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Your product notifications have been updated.');
?>